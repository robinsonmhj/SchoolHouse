...
public class BaseController {
	...
	public String index(ModelMap model) { // it will return the model
		...
		return "home"; // it is used to return to which jsp
	...
	public String news(ModelMap model) { // it will return the model
		...
		// Spring uses InternalResourceViewResolver and return back index.jsp
		return "news"; // it is used to return to which jsp

	}
	
	@RequestMapping(value = "/portfolio", method = RequestMethod.GET)
	public String portfolio(ModelMap model) { // it will return the model
		...
		// Spring uses InternalResourceViewResolver and return back index.jsp
		return "portfolio"; // it is used to return to which jsp

	}
	
	
	@RequestMapping(value = "/service", method = RequestMethod.GET)
	public String service(ModelMap model) { // it will return the model
		...
		// Spring uses InternalResourceViewResolver and return back index.jsp
		return "service"; // it is used to return to which jsp

	}
	
	
	@RequestMapping(value = "/team", method = RequestMethod.GET)
	public String team(ModelMap model) { // it will return the model
		...
		// Spring uses InternalResourceViewResolver and return back index.jsp
		return "team"; // it is used to return to which jsp

	}
	
	/*
	@RequestMapping(value = "/houseDetail", method = RequestMethod.GET)
	public String homeDetail(HttpServletRequest request) { // it will return the model

		Long postId=Long.valueOf(request.getParameter("pid"));
		
		return "houseDetail"; // it is used to return to which jsp
